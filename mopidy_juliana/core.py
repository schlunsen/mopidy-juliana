...
class JuliananCore(pykka.ThreadingActor):
    ...
    ##
    def start(self):
        logger.info("Starting Juliana " + Extension.version)
    ...
    def get_config(self, *args, **kwargs):
        ...
        # juliana won't work properly anyway, but at least we won't get server
        # errors
        ...
        #         "country": self.config["juliana"]["country"],
        #         "locale": self.config["juliana"]["locale"],
        #         "spotify_authorization_url": self.config["juliana"][
        #             "spotify_authorization_url"
        #         ],
        #         "lastfm_authorization_url": self.config["juliana"][
        #             "lastfm_authorization_url"
        #         ],
        #         "genius_authorization_url": self.config["juliana"][
    ...
    async def get_version(self, *args, **kwargs):
        ...
        callback = kwargs.get("callback", False)
        url = "https://pypi.python.org/pypi/Mopidy-Juliana/json"
    ...
    def restart(self, *args, **kwargs):
        ...
        # Trigger the action
        julianaSystemThread("restart", ioloop, self.restart_callback).start()
    ...
    def upgrade(self, *args, **kwargs):
        ...
        # Trigger the action
        julianaSystemThread("upgrade", ioloop, self.upgrade_callback).start()
    ...
    def local_scan(self, *args, **kwargs):
        ...
        # Trigger the action
        julianaSystemThread("local_scan", ioloop, self.local_scan_callback).start()
    ...
    async def load_more_tracks(self, *args, **kwargs):
        try:
            ...
            error = "julianaFrontend: access_token missing or invalid"
            logger.error(error)
            return False
    ...
    def add_radio_metadata(self, added):
        ...
        metadata = {
            "tlids": [],
            "added_by": "Radio",
            "added_from": "juliana:radio:" + seeds,
        }
    ...
    #
    # This maps tltracks with extra info for display in juliana, including
    ...
    def test(self, *args, **kwargs):
        ...
        julianaSystemThread("test", ioloop, self.test_callback).run()
